...
<body class="flex bg-orange-50 min-h-screen">
  <div class="w-64 bg-teal-800 text-white p-5 flex flex-col no-print">
    ...
    <ul class="flex-1 space-y-3">
      <li><a href="Kasir.php" class="block p-2 hover:bg-teal-600 rounded">Home</a></li>
      <li><a href="Konfirmasi.php" class="block p-2 hover:bg-teal-600 rounded">Pesanan</a></li>
      <li><a href="report.php" class="block p-2 bg-teal-700 rounded">Report</a></li>
    </ul>
