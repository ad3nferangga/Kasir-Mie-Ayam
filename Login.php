...
<body class="min-h-screen bg-gradient-to-br from-teal-500 to-blue-600 flex items-center justify-center">
  <div class="flex w-full max-w-4xl bg-white shadow-2xl rounded-lg overflow-hidden">
    ...
    <div class="w-1/2 p-10 flex flex-col justify-center">
      ...
      <form method="POST" action="login.php" class="space-y-6">
        <div>
          <label class="block text-gray-600 text-lg mb-2">Username</label>
        ...
        <div>
          <label class="block text-gray-600 text-lg mb-2">Password</label>
